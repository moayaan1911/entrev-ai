...
export default function Footer() {
  ...
  return (
    <div className='flex md:flex-row flex-col items-center justify-between py-2 md:px-8 px-4 border-t dark:border-white'>
      <div className='flex gap-1 items-center md:py-0 py-4'>
        Copyright <Copyright />
        {currentYear}
      </div>
      <div className='flex md:flex-row flex-col gap-4 items-center'>
        <Link
          href='/how-it-works'
          className={`hover:bg-gray-100 px-4 py-2 rounded-lg md:text-lg text-sm font-semibold flex items-center gap-2 hover:dark:text-black`}>
          <Zap /> How it Works?
        </Link>
        <Link
          href='/buy-code'
